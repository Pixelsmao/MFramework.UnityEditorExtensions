...
namespace MFramework.EditorExtensions
{
    public static class EditorGUIStyles
    {
        ...
        /// 弹出式平面按钮
        /// </summary>
        public static GUIStyle popupFlatButton { get; private set; }
        ...
        /// 黑暗窗口
        /// </summary>
        public static GUIStyle darkWindow { get; private set; }

        /// <summary>
        /// 左框对齐
        /// </summary>
        public static GUIStyle alignLeftBox { get; private set; }
        ...
        public static GUIStyle grayBackground { get; private set; }
        public static GUIStyle blackBackground { get; private set; }

        public static GUIStyle background(int width, int height, Color color)
        {
            return new GUIStyle
            {
                normal =
                {
                    background = CreateBackgroundTexture(width, height, color)
                }
            };
        }
        ...
        private static void CreateGrayBackground()
        {
            grayBackground = new GUIStyle
            {
                normal =
                {
                    background = CreateBackgroundTexture(4, 4, new Color(0.25f, 0.25f, 0.25f, 1f))
                }
            };
        }

        private static void CreateBlackBackground()
        {
            blackBackground = new GUIStyle
            {
                normal =
                {
                    background = CreateBackgroundTexture(4, 4, new Color(0.15f, 0.15f, 0.15f, 1f))
                }
            };
        }

        private static Texture2D CreateBackgroundTexture(int width, int height, Color color)
        {
        ...
        private static void CreateLinkStyle()
        {
